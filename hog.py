...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    new= simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(new)
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while player_score < goal:
        ...
        while opp_score < goal:
            if strategy( player_score, opp_score )!= numroll:
                rolls=False
            opp_score+=1
            roll=True
        player_score+=1
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    ##sus_update(0, score, opponent_score, dice=six_sided)
